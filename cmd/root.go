...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.fiord.yaml)")
...
func initConfig() {
	...
	viper.SetConfigName(".fiord") // name of config file (without extension)
